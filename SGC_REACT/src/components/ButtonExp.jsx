...
export function ButtonExp() {
  ...
  const handleExportPDF = async () => {
    ...
    if (data && data.length > 0) {
      ...
      doc.text("Reporte de Vendedoras", 14, 15);
      doc.setFontSize(10);
  ...
  return (
    <div className="flex gap-3">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-file-earmark-excel" viewBox="0 0 16 16">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-file-earmark-pdf-fill" viewBox="0 0 16 16">
