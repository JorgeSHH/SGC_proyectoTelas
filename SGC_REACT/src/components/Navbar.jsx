        ...
        <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4 hover:cursor-pointer">
              <a href="http://localhost:5173/adm-menu">   <img
                src={miLogo}
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="flex items-center space-x-6 rounded-full">
      ...
      >
        <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center h-12 space-x-8">
            <a href='http://localhost:5173/gestion-ven' className="text-gray-900 hover:text-[#ec4444] px-3 py-2 rounded-md text-sm font-bold  transition">
          ...
          <div className="flex md:hidden items-center justify-around h-14 w-full bg-white/80 backdrop-blur-sm -mx-4 px-4 border-t border-gray-200">
            ...
            {/* Icono Vendedoras */}
            <a href="http://localhost:5173/gestion-ven" className="flex flex-col items-center justify-center text-gray-600 hover:text-[#ec4444]">
            ...
            {/* Icono Telas */}
            <a href="http://localhost:5173/registro-tipos-tela" className="flex flex-col items-center justify-center text-gray-600 hover:text-[#ec4444]">
