...
export function Navbar() {
  ...
  const handleLogout = async () => {
    // Obtenemos los tokens (usamos las claves que guardaste en Login.jsx)
    const refreshToken = localStorage.getItem("refresh");
    const accessToken = localStorage.getItem("access");

    try {
        // 1. Avisar al servidor (para invalidar el token en la lista negra/Blacklist)
    ...
    // 2. Limpiar todo pase lo que pase (Tokens y datos de usuario)
    localStorage.clear(); 
      ...
      >
        <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            {/* Información del usuario - MATCH POR EMAIL */}
            <div className="flex items-center space-x-4">
              ...
              {/* Agregamos onClick={handleLogout} aquí */}
              <button 
      ...
      >
        <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center h-12 space-x-8">
            <a href='/gestion-ven' className="text-gray-900 hover:text-[#ec4444] px-3 py-2 rounded-md text-sm font-bold  transition">
              Gestión de Vendedoras
            </a>
            <a href="/registro-tipos-tela" className="text-gray-600 hover:text-[#ec4444] px-3 py-2 rounded-md text-sm font-bold  transition">
              Gestión de Telas
            </a>
            <a href="/gestion-retazos" className="text-gray-600 hover:text-[#ec4444] px-3 py-2 rounded-md text-sm font-bold  transition">
              Gestión de Retazos
            </a>
            <a href="/dashboard" className="text-gray-600 hover:text-[#ec4444] px-3 py-2 rounded-md text-sm font-bold  transition">
          ...
          <div className="flex md:hidden items-center justify-around h-14 w-full bg-white/80 backdrop-blur-sm -mx-4 px-4 border-t border-gray-200">
            ...
            {/* Icono Vendedoras */}
            <a href="/gestion-ven" className="flex flex-col items-center justify-center text-gray-600 hover:text-[#ec4444]">
            ...
            {/* Icono Telas */}
            <a href="/registro-tipos-tela" className="flex flex-col items-center justify-center text-gray-600 hover:text-[#ec4444]">
            ...
            {/* Icono Retazos */}
            <a href="/gestion-retazos" className="flex flex-col items-center justify-center text-gray-600 hover:text-[#ec4444]">
            ...
            {/* Icono Dashboard */}
            <a href="/dashboard" className="flex flex-col items-center justify-center text-gray-600 hover:text-[#ec4444]">
