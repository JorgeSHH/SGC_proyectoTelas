        ...
        <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4 hover:cursor-pointer">
              <a href="http://localhost:5173/ven-menu">   
                <img
                  src={miLogo}
              ...
              <div className="text-right">
                <p className="text-sm text-white font-bold uppercase">
                  {loading 
                    ? "Cargando..." 
                    : salesWomanData 
                    ? salesWomanData.email // Muestra "andrea_ventas"
                    : "No identificado"}
                </p>
      ...
      >
        <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center h-12 space-x-8">
            <a href='http://localhost:5173/registro-retazos' className="text-gray-900 hover:text-[#ec4444] px-3 py-2 rounded-md text-sm font-bold  transition">
              Registro de retazos 
            </a>
